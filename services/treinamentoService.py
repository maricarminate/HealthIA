...
#2- Separar os dados em treino (75%) (X_treino, Y_treino) e teste (25%) (X_teste, Y_teste)
...
def treinar_modelo():
    """
    Função para treinar o modelo de Machine Learning utilizando XGBoost.
    ...
    #deixando o modelo mais potente, com bons hiperparametros
